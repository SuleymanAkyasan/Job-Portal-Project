...
import com.suleyman.jobportal.repository.JobSeekerProfileRepository;
import com.suleyman.jobportal.repository.RecruiterProfileRepository;
...
public class UsersService {
    ...
    public Object getCurrentUserProfile() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Users users = usersRepository.findByEmail(username).orElseThrow(() -> new UsernameNotFoundException("Couldn't found user"));
